...
(function($) {
  ...
  setInterval(function() {
    ...
    // Check if article is visible and add class to body
...
/*function toggleArticle(article) {
  ...
  article.toggleClass('is-article-visible');
  ...
  // Toggle bg effect
  if ($('body').hasClass('is-article-visible')) {
    $('#bg:after').addClass('is-visible');
  } else {
    $('#bg:after').removeClass('is-visible');
  }
}*/
